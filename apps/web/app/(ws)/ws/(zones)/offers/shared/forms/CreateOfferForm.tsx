...
import type { OfferCaseType } from "@/server/contracts/offers";
...
import {
  ...
  type OfferFormState,
} from "./CreateOfferForm.state";

export { buildSubmitPayload } from "./CreateOfferForm.state";
...
export default function CreateOfferForm({
  ...
  const [form, setForm] = useState<OfferFormState>(() => buildInitialState(properties, initialData));
