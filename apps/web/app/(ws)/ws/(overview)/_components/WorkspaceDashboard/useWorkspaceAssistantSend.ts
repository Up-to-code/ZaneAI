...
import type { ZaneAiProInputMode, ZaneAiProStreamStageEvent, ZaneAiProThread } from "@/server/contracts/zaneAiPro";
import type { UploadedFileReference } from "@/server/contracts/files";
import { runSendFlow, type SendOptions } from "./useWorkspaceAssistantSend.flow";

type UseWorkspaceAssistantSendParams = {
  thread: ZaneAiProThread | null;
