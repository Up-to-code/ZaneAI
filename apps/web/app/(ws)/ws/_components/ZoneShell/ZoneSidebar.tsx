...
export default function ZoneSidebar({
  ...
  return (
    <aside
      ...
      className="flex h-full flex-col border-e border-[color:var(--workspace-border)] bg-[var(--zane-ai-deep)] text-white"
    >
      {/* Brand Header */}
      ...
      <div className="border-b border-white/[0.06] px-3 py-3">
        <Link
          href="/ws"
          className="flex items-center justify-between rounded-2xl bg-white/[0.04] px-4 py-2.5 text-[10px] font-bold tracking-wide text-[var(--zane-ai-text-secondary)] transition-all duration-150 hover:bg-[var(--zane-ai-accent-soft)] hover:text-[var(--zane-ai-accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--zane-ai-accent)] active:scale-[0.98]"
        >
