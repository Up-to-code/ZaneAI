...
const tones = {
  ...
  dark: "border border-white/10 bg-[var(--zayon-deep)] text-white",
  muted: "border border-[color:var(--workspace-border)] bg-[var(--workspace-elevated)] text-[var(--workspace-bubble-other-foreground)]",
  warn: "border border-[color:color-mix(in_srgb,var(--zayon-accent)_24%,transparent)] bg-[var(--workspace-accent-soft)] text-[var(--workspace-bubble-other-foreground)]",
};
