  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-[color:var(--workspace-border)] bg-[color:color-mix(in_srgb,var(--workspace-panel)_92%,transparent)] text-[var(--workspace-muted)] shadow-[0_10px_28px_rgba(10,20,40,0.08)] transition-all hover:bg-[var(--workspace-accent-soft)] hover:text-foreground hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_srgb,var(--workspace-highlight)_28%,transparent)] active:scale-95"
      ...
      <Dialog.Root open={open} onOpenChange={setOpen}>
        <Dialog.Portal>
          <Dialog.Backdrop
            className="fixed inset-0 z-50 bg-[rgba(7,16,29,0.68)] backdrop-blur-sm transition-opacity duration-300 data-[ending-style]:opacity-0 data-[starting-style]:opacity-0 lg:hidden"
          />
