...
import {
  ...
  formatLocaleNumber,
  type AppLocale,
} from "../../../../../packages/ag-ui/src/zaneai/locale";
import { formatWebCopy, getWebDictionary } from "../../../../../packages/ag-ui/src/zaneai/i18n";
...
export type AppDictionary = ReturnType<typeof getWebDictionary> & MobileDictionary;
