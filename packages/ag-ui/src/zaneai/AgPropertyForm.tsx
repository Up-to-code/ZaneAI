...
/**
 * WHY:   The current ZaneAI project workflow relies on a rich, media-aware property form that is still tied to workspace adapters.
 * WHAT:  Exposes the existing ZaneAI property form through the package `zaneai` entrypoint without forcing it into the generic core.
        ...
        <div className="flex flex-col gap-8">
          <div className="border border-slate-200 bg-white p-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div
                className={cn(
                  "group col-span-2 mt-2 flex flex-row-reverse items-center justify-between border-2 p-4 text-right transition-all",
                  formState.video ? "border-blue-600 bg-blue-50/20" : "border-slate-100 bg-white",
                )}
              >
