...
const dictionaries: Record<AppLocale, WebDictionary> = {
  ...
  en: {
    landing: {
      ...
      heroTitle: "AI-Powered Infrastructure That Operates",
      heroDescription: "The first real estate connective layer that pulls live structural data in real-time as you search—giving you accurate, reliable metadata to execute your workflow.",
      heroTryFree: "Try App For Free",
      ...
      ctaTitle: "Shift from manual to automatic.",
      ctaDescription: "Start utilizing the infrastructure behind top performing institutional real estate deployments.",
    ...
    hero: {
      subtitle: "The first real estate connective layer that pulls live structural data in real-time as you search—giving you accurate, reliable metadata to execute your workflow.",
    },
    cta: {
